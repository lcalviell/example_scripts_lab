...
opts <- BamFile(file="/bfd/lcalviel/data/riboseq/DDX3_markus/results/RP_siDDX3_rep1/starmapp_25_RP_siDDX3_rep1/RP_siDDX3_rep1_Aligned.sortedByCoord.out.bam", yieldSize=5000000)
...
load("/bfd/lcalviel/data/parclip/results_stringent/DDX3_wt_untr_rep1/DDX3_wt_untr_rep1_rRNA_bowtie.bam_mut_rl_Robj")
